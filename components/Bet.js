    ...
    return (
        <div>
            <div className="z-10 absolute w-full mt-20">
                <div>
                    <div className={"bg-red-500 rounded-xl w-8/12 sm:w-7/12 md:w-6/12 lg:w-5/12 mx-auto text-center py-1 " + (isVisible ? "visble" : "invisible")}>
                        <span className="z-1 text-xs sm:text-sm md:text-md lg:text-lg text-ellipsis ">Your wallet is connected to the wrong network.Please switch to Rinkeby test network</span>
                    </div>
